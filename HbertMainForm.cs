...
namespace HBERT_UI
{
    public partial class HbertMainForm : Form
    {
        ...
        private void SubmitForm(HBFormUtils.CarbonExportStatus exportStatus)
        {
            if (!TextBoxesInput)
            {
        ...
        {
            SubmitForm(HBFormUtils.CarbonExportStatus.Final);
        }

        private void buttonDraft_Click(object sender, EventArgs e)
        {
            SubmitForm(HBFormUtils.CarbonExportStatus.Draft);
        }

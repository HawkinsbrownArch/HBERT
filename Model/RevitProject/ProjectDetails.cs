...
namespace CarbonEmissionTool.Model.RevitProject
{
    public class ProjectDetails
    {
        ...
        internal string Sector => StringUtils.GenerateSectorString(new string[] { Education, Workplace, Infrastructure, Residential, Civic });

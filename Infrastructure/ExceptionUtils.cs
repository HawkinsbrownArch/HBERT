...
namespace HBERT.Infrastructure
{
    class ExceptionUtils
    {
        ...
        internal static void ValidateCarbonSchedule(ViewSchedule schedule, ref bool isValid)
        {
            ...
            {
                TaskDialog td = new TaskDialog("HBERT")
                {

...
{
    /// <summary>
    /// The Floor Area heading title annotation. 
    /// </summary>
    class FloorAreaTitleAnnotation : IAnnotation
    {
        ...
        /// <summary>
        /// Constructs a new <see cref="FloorAreaTitleAnnotation"/> object.
        /// </summary>
        public FloorAreaTitleAnnotation(Autodesk.Revit.DB.View view)
        {

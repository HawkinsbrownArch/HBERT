...
{
    /// <summary>
    /// The location title value annotation of the scheme input by the user.
    /// </summary>
    class LocationValueAnnotation : IAnnotation
    {
        ...
        /// <summary>
        /// Constructs a new <see cref="LocationValueAnnotation"/> object.
        /// </summary>
        public LocationValueAnnotation(Autodesk.Revit.DB.View view, IProjectDetails projectDetails)
        {
